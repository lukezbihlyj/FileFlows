...
public interface IFileService
{
    ...
    /// - <c>false</c> if the directory contains files or subdirectories.
    /// - A failure result if an error occurs, including specific errors for unauthorized access or IO issues.
    /// </returns>
